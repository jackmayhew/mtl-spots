      ...
      <div className="section-mb80 main main_stays-category">
        <div className="main__center center">
          <div className="main__preview">
            {/* <video src="mobile.mp4" autoPlay loop muted className="mobile__video"></video>
            <video src="desktop.mp4" autoPlay loop muted className="desktop__video"></video> */}
            <video
